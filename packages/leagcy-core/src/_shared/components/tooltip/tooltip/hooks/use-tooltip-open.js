...
import { useControllableState, useEvent, useWatchValue } from '../../../../hooks';
export default function useTooltipOpen(props) {
    ...
    return [
        ...
        useEvent((action) => {
            ...
            if (delay === 0)
                ...
                timer.current = makeTimeout(delay, () => { setIsOpen(newIsOpen); });
        }),
    ];
}
