...
import type { HasChildren, PopupPlacement, SemanticStyledProps } from '../../../types'
...
export interface InternalTooltipProps
  extends Pick<OverlayProps, 'getContainer' | 'keepMounted' | 'unmountOnExit' | 'zIndex'>,
  Required<HasChildren<React.ReactElement>>,
