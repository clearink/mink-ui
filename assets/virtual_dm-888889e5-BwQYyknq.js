import{j as e,r as i}from"./index-W1RE6nsY.js";import{B as o}from"./index-CKwpuKI3.js";import{T as n}from"./index-B_U17hxC.js";import{S as l}from"./index-vc16XwVB.js";function N(){return e.jsx(n,{content:"prompt text",children:e.jsx("span",{children:"Tooltip will show on mouse enter."})})}const b={metaInfo:{"zh-CN":`最简单的用法，鼠标悬停即可显示 Tooltip。
...
\`\`\`
`,cssName:"css-c49593bf",relPath:"packages/core/src/tooltip/__docs__/examples/basic.md"},d=["topLeft","top","topRight"],u=["bottomLeft","bottom","bottomRight"],f=["leftTop","left","leftBottom"],g=["rightTop","right","rightBottom"];function y(){return e.jsxs("div",{className:"placement-grid",children:[e.jsx("div",{className:"placement-row",children:d.map(t=>e.jsx(n,{content:t,placement:t,children:e.jsx(o,{theme:"info",children:t})},t))}),e.jsxs("div",{className:"placement-row",children:[e.jsx("div",{className:"placement-side",children:f.map(t=>e.jsx(n,{content:t,placement:t,children:e.jsx(o,{theme:"info",children:t})},t))}),e.jsx("div",{className:"placement-center"}),e.jsx("div",{className:"placement-side",children:g.map(t=>e.jsx(n,{content:t,placement:t,children:e.jsx(o,{theme:"info",children:t})},t))})]}),e.jsx("div",{className:"placement-row",children:u.map(t=>e.jsx(n,{content:t,placement:t,children:e.jsx(o,{theme:"info",children:t})},t))})]})}const k={metaInfo:{"zh-CN":"通过 `placement` 属性设置 Tooltip 的弹出位置，支持 12 个方向。\n\n","en-US":"Set the popup position with the `placement` attribute. There are 12 placement options available.\n\n"},rawText:`\`\`\`tsx
...
\`\`\`
`,cssName:"css-04c76625",relPath:"packages/core/src/tooltip/__docs__/examples/arrow.md"},x=e.jsx("div",{children:"This is hover content."}),C=e.jsx("div",{children:"This is click content."});function A(){const[t,a]=i.useState(!1),[c,r]=i.useState(!1),p=()=>{a(!1),r(!1)},m=s=>{r(s),a(!1)},h=s=>{r(!1),a(s)};return e.jsx(n,{style:{width:200,textAlign:"center"},content:x,isOpen:c,trigger:"hover",onIsOpenChange:m,children:e.jsx(n,{style:{width:200,textAlign:"center"},content:e.jsxs("div",{children:[C,e.jsx(o,{size:"small",onClick:p,children:"Close"})]}),isOpen:t,trigger:"click",onIsOpenChange:h,children:e.jsx(o,{children:"Hover and click"})})})}const B={metaInfo:{"zh-CN":`Tooltip 嵌套时。
