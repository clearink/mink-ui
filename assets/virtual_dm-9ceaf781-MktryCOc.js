...
export default App
\`\`\`
`,cssName:"css-d86cb223",relPath:"packages/core/src/alert/__docs__/examples/description.md"};function oe(){return e.jsx("div",{children:["info","success","warning","error"].map(n=>e.jsx(d,{style:{marginBottom:8},closable:!0,showIcon:!0,action:e.jsx(Q,{size:"small",variant:"filled",children:"action"}),message:`${n} Text`,type:n},n))})}const re={metaInfo:{"zh-CN":"通过 `action` 可以自定义右上角操作项。\n\n","en-US":"通过 `action` 可以自定义右上角操作项。\n\n"},rawText:`\`\`\`tsx
