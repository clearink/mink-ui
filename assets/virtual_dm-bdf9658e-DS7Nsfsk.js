import{e as K,a as T,c as z,b as v,o as j,j as t,C as B,p as V,t as R,S as q,k as D,J as F,q as H,f as U}from"./index-D2XA0yST.js";import{i as $,W as J,u as G}from"./index-CdUc7RmQ.js";import{u as L}from"./index-CWi4WiNE.js";import{i as Q}from"./keyboard-C4wnD4uN.js";const X=K()(["collapsible","accordion","expandIcon","expandIconPlacement","keepMounted","item","expanded","outerNamespace","outerCssNames","outerCssAttrs","onChange"]);function Y(a,n){const{bordered:l,expandIconPlacement:s,size:e}=a,{ghost:r,prefixCls:d}=n,o=T("collapse",d);return{ns:o,classNames:{root:z(o,{[`${o}--bordered`]:l&&!r,[`${o}--ghost`]:r,[`${o}--icon-end`]:s==="end",[`${o}--lg`]:e==="large",[`${o}--sm`]:e==="small"})}}}function Z(a){const{expanded:n,collapsible:l,outerNamespace:s}=a,e=T(r=>`${s||`${r}-collapse`}-item`);return{ns:e,classNames:{root:z(e,{[`${e}--disabled`]:l==="disabled",[`${e}--expanded`]:n}),header:z(`${e}__header`,{[`${e}__header--collapsible`]:l==="header"}),icon:z(`${e}__icon`,{[`${e}__icon--collapsible`]:l==="icon"}),title:z(`${e}__title`,{[`${e}__title--collapsible`]:l==="title"}),extra:`${e}__extra`,content:`${e}__content`}}}function ee(a){const{item:n,accordion:l,collapsible:s,expanded:e,outerCssNames:r,outerCssAttrs:d,onChange:o}=a,{name:C}=n,{ns:f,classNames:u}=Z(a),[y,i]=v([r,u,n.classNames,{root:n.className}],[d,n.styles,{root:n.style}],{meta:a}),x=j(a,X);return{omitted:a,ns:f,cssNames:y,cssAttrs:i,restAttrs:x,resolveCollapsibleProps:m=>{if(!m.includes(s))return;const h=s==="disabled";return{"aria-expanded":e,"aria-disabled":h,tabIndex:h?-1:0,role:l?"tab":"button",onClick:h?void 0:()=>{o(C)},onKeyDown:h?void 0:c=>{Q(c.key,"enter")&&o(C)}}}}}function ne(a){const{omitted:n,ns:l,cssNames:s,cssAttrs:e,restAttrs:r,resolveCollapsibleProps:d}=ee(a),{item:o,accordion:C,expanded:f,expandIcon:u,keepMounted:y}=n,{ref:i,name:x,title:N,extra:m,children:h}=o,c=()=>{const p=V(u)?u({expanded:f,name:x}):u;return $(p)?t.jsx("span",{className:s.icon,style:e.icon,...d(["icon"]),children:p}):null};return t.jsxs("div",{...r,ref:i,className:s.root,style:e.root,children:[t.jsxs("div",{className:s.header,style:e.header,...d(["header"]),children:[c(),t.jsx("span",{className:s.title,style:e.title,...d(["title"]),children:N}),$(m)&&t.jsx("span",{className:s.extra,style:e.extra,children:m})]}),t.jsx(B,{classNames:`${l}-motion`,skipOnReenter:!0,mountOnEnter:!y,unmountOnExit:!y,when:f,onEnter:()=>({height:0}),onEntering:p=>({height:p.scrollHeight}),onExit:p=>({height:p.getBoundingClientRect().height}),onExiting:()=>({height:0}),children:(p,g)=>t.jsx("div",{ref:p,className:g.names(),style:g.attrs(),children:t.jsx("div",{className:s.content,style:e.content,role:C?"tabpanel":void 0,children:h})})})]})}function ae(a){const n=a;return t.jsx("svg",{...n,children:t.jsx("path",{d:"M715.8 493.5 335 165.1c-14.2-12.2-35-1.2-35 18.5v656.8c0 19.7 20.8 30.7 35 18.5l380.8-328.4c10.9-9.4 10.9-27.6 0-37"})})}const te=J(ae,{name:"caret-right",theme:"outlined"}),I={bordered:!0,collapsible:"header",expandIconPlacement:"start",expandIcon:t.jsx(te,{})};function A(a,n){return n?R(a).slice(0,1):R(a)}function se(a){const n=G("collapse"),l=q.use(),{accordion:s,expandedNames:e,defaultExpandedNames:r,onChange:d,size:o=l,bordered:C=I.bordered,collapsible:f=I.collapsible,expandIcon:u=I.expandIcon,expandIconPlacement:y=I.expandIconPlacement}=a,i=a,x={bordered:C,collapsible:f,expandIcon:u,expandIconPlacement:y,size:o},[N,m]=L(D(e)?void 0:A(e,s),()=>A(r,s),(S,b)=>{d?.(b,S)}),{ns:h,classNames:c}=Y(x,i),[p,g]=v([n.classNames,{root:n.className},c,i.classNames,{root:i.className}],[n.styles,{root:n.style},i.styles,{root:i.style}],{meta:{...i,...x,expandedNames:N}}),M={...j(p,["root","item"]),root:p.item},O={...j(g,["root","item"]),root:g.item},W=F(S=>{let b=N.concat();const k=b.indexOf(S),w=k!==-1;s?b=w?[]:[S]:w?b.splice(k,1):b.push(S),m(b,S)});return{picked:x,omitted:i,ns:h,cssNames:p,cssAttrs:g,expandedNames:N,outerCssNames:M,outerCssAttrs:O,handleChange:W}}function oe(a){const{picked:n,omitted:l,ns:s,cssNames:e,cssAttrs:r,expandedNames:d,outerCssNames:o,outerCssAttrs:C,handleChange:f}=se(a),{collapsible:u,expandIcon:y,expandIconPlacement:i}=n,{ref:x,items:N,accordion:m,keepMounted:h}=l;return t.jsx("div",{ref:x,className:e.root,style:r.root,role:m?"tablist":void 0,children:H(N)&&N.map(c=>t.jsx(ne,{accordion:m,collapsible:U(c.collapsible,u),expanded:m?d[0]===c.name:d.includes(c.name),expandIcon:U(c.expandIcon,y),expandIconPlacement:U(c.expandIconPlacement,i),item:c,keepMounted:U(c.keepMounted,h),outerCssAttrs:C,outerCssNames:o,outerNamespace:s,onChange:f},c.name))})}const E=Object.assign(oe,{}),P=`
