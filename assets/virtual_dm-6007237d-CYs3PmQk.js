import{p as ke,n as M,O as E,P as le,x as _e,Q as ae,z as ue,A as ye,r as h,j as r,T as Oe,U as me,J as N,k as j,e as Te,V as ze,W as Fe,I as Re,s as He,F as re,v as Ae,a as he,D as Se,m as Le,c as ce,f as b,b as Ve,B as fe,d as We,G as De,X as Je,E as Ke}from"./index-MrfF1wwl.js";import{u as qe,B as p,S as Ge,i as pe}from"./index-BUUmuQX0.js";import{s as A,u as Me,O as Xe,p as Ye}from"./index-BQK0WB1A.js";import{S as je}from"./index-CIc82ULJ.js";import{i as we}from"./keyboard-C4wnD4uN.js";import{c as Qe}from"./children-BYkTuB6U.js";import{g as ve,n as Ze,m as et}from"./closable-qvUxyvLg.js";import{C as tt,i as de}from"./index-Ilq8771D.js";const be={position:"fixed",overflow:"hidden",width:0,height:0,top:-1,left:-1,padding:0};function nt(s,e){let t=s.nextElementSibling;const n=[];for(;t&&t!==e;)n.push(t),t=t.nextElementSibling;return n}function H(s){s&&ke(s.focus)&&s.focus({preventScroll:!0})}class ot{_stack=[];_subscribers=0;_keydownCleanup=M;_focusinCleanup=M;init=e=>{const t=n=>o=>{const a=_e(this._stack,-1);a&&a[n](o)};this._keydownCleanup=E(e,"keydown",t("onKeyDown"),!0),this._focusinCleanup=E(e,"focusin",t("onFocusIn"))};clear=()=>{this._keydownCleanup(),this._focusinCleanup()};subscribe=e=>le?(this._subscribers++===0&&this.init(e),()=>{--this._subscribers===0&&this.clear(),this._subscribers=Math.max(this._subscribers,0)}):M;register=e=>(this._stack.push(e),()=>{this._stack=this._stack.filter(t=>t!==e)})}const Ce=new ot;class st{_props={};_isShiftTab=!1;_latestFocus=null;_savedElement=null;$start={current:null};$end={current:null};get start(){return this.$start.current}get end(){return this.$end.current}_bind=e=>{this._props=e};restoreFocus=()=>{const{returnFocus:e}=this._props;e&&H(this._savedElement)};handleFocus=(e,t)=>{if(!t||!this.start||!this.end)return;const n=nt(this.start,this.end);if(!n.length)return;const o=e.activeElement;if(o!==this.start&&o!==this.end){if(n.some(a=>a===t||a.contains(t))){this._latestFocus=t;return}if(this._latestFocus)return H(this._latestFocus)}H(this._isShiftTab?this.end:this.start)};subscribe=()=>Ce.subscribe(ae());activate=e=>{if(!e)return;const t=ae(this.start);this._savedElement=t.activeElement;const n=Ce.register({onKeyDown:o=>{this._isShiftTab=o.shiftKey&&we(o.key,"tab"),this.handleFocus(t,o.target)},onFocusIn:o=>{o.stopImmediatePropagation(),this.handleFocus(t,o.target)}});return()=>{n(),this.restoreFocus(),this._latestFocus=null,this._savedElement=null}}}function at(s){const{ref:e,active:t}=s,n=ue(()=>new st);return ye(()=>{n._bind(s)}),h.useImperativeHandle(e,()=>({focus:()=>{H(n.start)}}),[n]),h.useEffect(()=>n.subscribe(),[n]),h.useEffect(()=>n.activate(!!t),[t,n]),{omitted:s,ctrl:n}}function rt(s){const{omitted:e,ctrl:t}=at(s),{children:n,active:o}=e;return r.jsxs(r.Fragment,{children:[r.jsx("div",{ref:t.$start,style:be,tabIndex:o?0:-1}),n,r.jsx("div",{ref:t.$end,style:be,tabIndex:o?0:-1})]})}class ct{_stack=[];_lockDuration=200;_lastEndTime=0;_subscribers=0;_keydownCleanup=M;_composedCleanup=M;init=()=>{const e=Oe();this._composedCleanup=E(e,"compositionend",()=>{this._lastEndTime=me()}),this._keydownCleanup=E(e,"keydown",t=>{!we(t.key,"esc")||t.isComposing||me()-this._lastEndTime<this._lockDuration||_e(this._stack,-1)?.(t)})};clear=()=>{this._keydownCleanup(),this._composedCleanup()};subscribe=()=>{if(le)return this._subscribers++===0&&this.init(),()=>{--this._subscribers===0&&this.clear(),this._subscribers=Math.max(this._subscribers,0)}};activate=(e,t)=>{if(e)return this._stack.push(t),()=>{this._stack=this._stack.filter(n=>n!==t)}}}const xe=new ct;function it(s,e){const t=N(e);h.useEffect(()=>xe.subscribe(),[]),h.useEffect(()=>xe.activate(s,t),[s,t])}function se(s){const e=s?.focusable;return e===!0?{}:e}function lt(s){const{currentState:e,contextState:t,defaultState:n}=s,o=[se(e),se(t),se(n)];return o.find(l=>!j(l))&&A(...o.filter(l=>!!l),{focusTrap:!0,returnFocus:!0})||void 0}function ut(s){const{currentState:e,contextState:t,defaultState:n}=s,o=A(e?.slots||{},t?.slots||{},n?.slots||{});return a=>{const{name:i,params:l,children:c}=a,u=o[i];return u?u(c,l):c}}const v={keyboard:!0,maskClosable:!0,centered:!1,closable:!0,focusable:!0},dt={width:416,type:"confirm",closable:!1,maskClosable:!1},mt=Te()(["width","type","closable","maskClosable"]);class ht{_subjects=new Map;on=(e,t)=>{const n=this._subjects.get(e)||new Set;return this._subjects.set(e,n.add(t)),()=>this.off(e,t)};off=(e,t)=>{const n=this._subjects.get(e);n&&(n.delete(t),n.size||this._subjects.delete(e))};emit=(e,...t)=>{const n=this._subjects.get(e);n&&n.forEach(o=>o(...t))}}class ft{_listeners=new Set;_subscribers=0;_cleanup=null;init=()=>{const e=ae().documentElement;this._cleanup=E(e,"click",t=>{this._listeners.forEach(n=>{n(t)})},!0)};clear=()=>{this._cleanup?.(),this._cleanup=null};subscribe=()=>{if(le)return this._subscribers++===0&&this.init(),()=>{--this._subscribers===0&&this.clear(),this._subscribers=Math.max(this._subscribers,0)}};activate=(e,t)=>{if(e)return this._listeners.add(t),()=>{this._listeners.delete(t)}}}const ge=new ft;function Ne(){let s,e;return{promise:new Promise((n,o)=>{s=n,e=o}),resolve:s,reject:e}}const pt={};function bt(s){const{ref:e}=s,[t,n]=h.useState(()=>ie.get()),[o,a]=$e();return h.useImperativeHandle(e,()=>({get confirm(){return o.confirm},sync:()=>{n(ie.get())}}),[o,n]),{ctxHolder:a,modalConfig:t}}function Ct(s){const{ctxHolder:e,modalConfig:t}=bt(s);return r.jsx(tt,{modal:t,children:e})}class xt{_cleanup=null;position=void 0;clear=()=>{this._cleanup?.(),this._cleanup=null};sync=e=>{const t=e.target,n=e.detail===0||!e.pageX&&!e.pageY,o=n&&t?t.getBoundingClientRect():null;!o&&n?this.position=void 0:o?this.position={x:o.left+o.width/2,y:o.top+o.height/2}:this.position={x:e.clientX,y:e.clientY},this.clear(),this._cleanup=Re(200,()=>{this.position=void 0})};subscribe=()=>{ge.subscribe(),ge.activate(!0,this.sync)}}const Ee=new xt;class gt{_config={...pt};get=()=>({...this._config});set=e=>{this._config=A(e,this.get())}}const ie=new gt;class kt{_cleanup=null;_container=null;_callbacks=[];ensure=()=>this._container?this._container:new Promise(e=>{ze.createRoot(document.createDocumentFragment()).render(r.jsx(h.StrictMode,{children:r.jsx(Ct,{ref:t=>{e(this._container??=t)}})}))});clear=()=>{this._cleanup?.(),this._cleanup=null};flush=()=>{this.clear(),this._cleanup=Fe(()=>{const e=this.ensure(),t=n=>{n.sync(),this._callbacks.forEach(o=>{o(n)}),this._callbacks.length=0};de(e)?e.then(t):t(e)})};config=e=>{ie.set(e),this._container?.sync()};confirm=e=>{const{promise:t,resolve:n}=Ne();return this._callbacks.push(o=>{n({inner:o.confirm(e)})}),this.flush(),{then:o=>t.then(({inner:a})=>{a.then(o)}),update:o=>{t.then(({inner:a})=>{a.update(o)})},close:()=>{t.then(({inner:o})=>{o.close()})}}};expose=()=>{const{confirm:e,config:t}=this;return Object.assign(ve().reduce((n,o)=>(n[o]=a=>e({...a,type:o}),n),{}),{confirm:e,config:t})}}const _t=new kt;Ee.subscribe();class yt{$$channel=new ht;confirm=!1;cancel=!1;emit=(e,t)=>{this[e]=t,this.$$channel.emit(e,t)};on=(e,t)=>this.$$channel.on(e,t);resolve=(e,t,n,o)=>{if(e||!de(n))return o?.();this.emit(t,!0),n.then(()=>{this.emit(t,!1),o?.()},()=>{this.emit(t,!1)})};reset=()=>{this.emit("confirm",!1),this.emit("cancel",!1)}}class St{$$loading=new yt;$trap={current:null};transform=void 0;get trap(){return this.$trap.current}prepare=e=>{this.trap?.focus();const t=Ee.position;if(!t)return this.transform;const n=e.getBoundingClientRect(),o=t.x-n.left-(n.width-e.offsetWidth)/2,a=t.y-n.top-(n.height-e.offsetHeight)/2;return this.transform={transformOrigin:`${o}px ${a}px`},this.transform};reset=()=>{this.transform=void 0}}function Mt(s,e){const t=Object.keys(s),n=Object.keys(e);return t.length!==n.length?!1:t.every(o=>re(s[o],e[o]))}function jt(s,e){if(j(e))return;if(!He(e))return{width:e};const t={},n=(o,a)=>{j(a)||(t[`--${s}-${o}-width`]=Ae(a)?`${a}px`:`${a}`)};return n("xs",e.xs),n("sm",e.sm),n("md",e.md),n("lg",e.lg),n("xl",e.xl),n("xxl",e.xxl),t}function wt(s,e){const{centered:t}=s,{_isJsxModal:n,prefixCls:o,width:a,type:i}=e,l=he(f=>f),c=he("modal",o),u=Se(()=>jt(c,a),[c,a],Le);return{rns:l,ns:c,cssVars:u,classNames:{root:ce(c,{[`${c}--centered`]:t,[`${c}--confirm`]:!n,[`${c}--confirm-${i}`]:!n&&i}),mask:`${c}-mask`,main:`${c}__main`,header:`${c}__header`,title:`${c}__title`,statusIcon:`${c}__status-icon`,closeBtn:`${c}__close-btn`,body:`${c}__body`,footer:`${c}__footer`}}}function vt(s){const e=qe("modal"),{_isJsxModal:t,_onDismiss:n,isOpen:o,confirmLoading:a,slots:i,onOk:l,onCancel:c,onOpened:u,onClosed:f,keyboard:_=b(e.keyboard,v.keyboard),maskClosable:C=b(e.maskClosable,v.maskClosable),centered:L=b(e.centered,v.centered),closable:$=b(e.closable,v.closable),focusable:V=b(e.focusable,v.focusable)}=s,g=s,P={maskClosable:C,centered:L,closable:$},x=ue(()=>new St),[I,U]=h.useState(o),{rns:W,ns:D,cssVars:O,classNames:T}=wt(P,g),[J,z]=Ve([e.classNames,{root:e.className},T,g.classNames,{root:g.className}],[e.styles,{root:e.style},g.styles,{root:g.style},{root:O}],{meta:{...g,...P}}),K=ut({currentState:{slots:i},contextState:{slots:e.slots}}),q=lt({currentState:{focusable:V},contextState:{focusable:e.focusable},defaultState:{focusable:!0}}),[y,G]=Ze({currentState:{closable:$},contextState:{closable:e.closable}}),X=N((d,m)=>t?M:x.$$loading.on(d,m)),Y=N(d=>{t&&a||!t&&x.$$loading.confirm||x.$$loading.resolve(t,"confirm",l?.(d))}),Q=N(d=>{t&&a||!t&&x.$$loading.cancel||x.$$loading.resolve(t,"cancel",c?.(d),y?.onClose)}),w=N(d=>{t&&a||(t?c?.(d):n?.(d),y?.onClose?.())}),Z=d=>{C&&d.target===d.currentTarget&&w(d)},ee=()=>{u?.()},te=()=>{U(!1),f?.(),y?.onClosed?.(),x.reset()},ne=fe(!!o,()=>{U(!0)},(d,m)=>!d||re(d,m)),oe=fe(t,()=>{x.$$loading.reset()},(d,m)=>!d||re(d,m));return it(!!o&&!!_,w),{omitted:g,rns:W,ns:D,cssNames:J,cssAttrs:z,ctrl:x,visible:I,renderSlots:K,focusableState:q,closeIconRender:G,returnEmpty:ne||oe,subscribe:X,handleOk:Y,handleCancel:Q,handleDismiss:w,handleEntered:ee,handleExited:te,handleClick:Z}}const B=We("ModalFooterContext",{});function Nt(s){const{_showCancel:e,confirmLoading:t,confirmText:n,confirmButtonProps:o,cancelText:a,cancelButtonProps:i,subscribe:l,onOk:c,onCancel:u}=s,f=Se(()=>({_showCancel:e,confirmText:n,confirmLoading:t,confirmButtonProps:o,cancelText:a,cancelButtonProps:i,subscribe:l,onOk:c,onCancel:u}),{_showCancel:e,confirmText:n,confirmLoading:t,confirmButtonProps:o,cancelText:a,cancelButtonProps:i,subscribe:l,onOk:c,onCancel:u},Mt);return{omitted:s,modalFooterContextValue:f}}function Et(){const s=B.use(),{cancelButtonProps:e,cancelText:t,onCancel:n}=s,{theme:o="info",children:a=b(t,"取消"),onClick:i=n}=e||{};return{picked:{children:a,theme:o,onClick:i},omitted:e}}function Bt(){const s=B.use(),{confirmLoading:e,confirmText:t,confirmButtonProps:n,onOk:o}=s,{variant:a="solid",loading:i=e,children:l=b(t,"确认"),onClick:c=o}=n||{};return{picked:{children:l,variant:a,loading:i,onClick:c},omitted:n}}function $t(){const s=B.use(),{_showCancel:e,cancelText:t,cancelButtonProps:n,subscribe:o,onCancel:a}=s,{theme:i="info",loading:l,children:c=b(t,"取消"),onClick:u=a}=n||{},f={children:c,theme:i,onClick:u},[_,C]=Me(l,()=>!1);return h.useEffect(()=>o?.("cancel",C),[o,C]),{omitted:n,picked:f,isLoading:_,visible:e}}function Pt(){const s=B.use(),{confirmText:e,confirmButtonProps:t,subscribe:n,onOk:o}=s,{loading:a,theme:i="primary",variant:l="solid",children:c=b(e,"确认"),onClick:u=o}=t||{},f={children:c,theme:i,variant:l,onClick:u},[_,C]=Me(a,()=>!1);return h.useEffect(()=>n?.("confirm",C),[n,C]),{omitted:t,picked:f,isLoading:_}}function It(){const{picked:s,omitted:e}=Et();return r.jsx(p,{...e,...s})}function Ut(){const{picked:s,omitted:e}=Bt();return r.jsx(p,{...e,...s})}function Ot(){const{picked:s,omitted:e,isLoading:t,visible:n}=$t();return n?r.jsx(p,{...e,...s,loading:t}):null}function Tt(){const{picked:s,omitted:e,isLoading:t}=Pt();return r.jsx(p,{...e,...s,loading:t})}function zt(s){const{omitted:e,modalFooterContextValue:t}=Nt(s),{_isJsxModal:n,footer:o}=e,a=()=>{const i=ke(o);if(!i&&!j(o))return o;const u={cancelButton:n?r.jsx(It,{}):r.jsx(Ot,{}),confirmButton:n?r.jsx(Ut,{}):r.jsx(Tt,{})},f=r.jsxs(r.Fragment,{children:[u.cancelButton,u.confirmButton]});return r.jsx(B,{value:t,children:i?o(f,u):f})};return r.jsx(De,{value:!1,children:a()})}function Be(s){const{omitted:e,rns:t,ns:n,cssNames:o,cssAttrs:a,ctrl:i,visible:l,renderSlots:c,focusableState:u,closeIconRender:f,returnEmpty:_,subscribe:C,handleOk:L,handleCancel:$,handleDismiss:V,handleEntered:g,handleExited:P,handleClick:x}=vt(s),{_isJsxModal:I,_showCancel:U,children:W,type:D,title:O,footer:T,mask:J,isOpen:z,fresh:K,zIndex:q,transitions:y,getContainer:G,mountOnEnter:X,unmountOnExit:Y,confirmLoading:Q,confirmText:w,confirmButtonProps:Z,cancelText:ee,cancelButtonProps:te}=e,ne=m=>{const{focusTrap:k,returnFocus:Ue}=u||{};return k?r.jsx(rt,{ref:i.$trap,active:l,returnFocus:Ue,children:m}):m},oe=()=>f((m,k)=>r.jsx("button",{className:o.closeBtn,style:a.closeBtn,disabled:k,tabIndex:0,type:"button",onClick:V,children:m})),d=()=>{if(I)return null;const m=et(D,"warning");return Qe(m,{fallback:r.jsx("span",{className:o.statusIcon,style:a.statusIcon,children:m}),transform:k=>({className:ce(k.className,o.statusIcon),style:{...k.style,...a.statusIcon}})})};return _?null:r.jsx(Xe,{classNames:{mask:o.mask},styles:{mask:a.mask},resumeOnCancel:!0,getContainer:G,isOpen:z,mask:J,mountOnEnter:X,transitions:{mask:b(y?.mask,`${t}-fade-in`),content:b(y?.content,`${t}-zoom-in`)},unmountOnExit:Y,zIndex:q,onEnter:m=>i.prepare(m),onEntered:g,onEntering:()=>i.transform,onExit:()=>i.transform,onExited:P,onExiting:()=>i.transform,children:(m,k)=>r.jsx("div",{className:`${n}-wrapper`,style:l?void 0:{display:"none"},tabIndex:-1,onClick:x,children:r.jsx("div",{ref:m,className:ce(o.root,k.names()),style:{...a.root,...k.attrs()},children:c({name:"main",children:ne(r.jsx(Ge,{when:()=>!!(z||K),children:r.jsxs("div",{className:o.main,style:a.main,children:[oe(),d(),pe(O)&&r.jsx("div",{className:o.header,style:a.header,children:r.jsx("span",{className:o.title,style:a.title,children:O})}),r.jsx("div",{className:o.body,style:a.body,children:W}),pe(T,j)&&r.jsx("div",{className:o.footer,style:a.footer,children:r.jsx(zt,{_isJsxModal:I,_showCancel:U,cancelButtonProps:te,cancelText:ee,confirmButtonProps:Z,confirmLoading:Q,confirmText:w,footer:T,subscribe:C,onCancel:$,onOk:L})})]})}))})})})})}function Ft(s){return r.jsx(Be,{...s,_isJsxModal:!1})}function Rt(s){return r.jsx(Be,{...s,_isJsxModal:!0})}function Ht({items:s}){return r.jsx(r.Fragment,{children:Array.from(s).map(([e,{config:t,isOpen:n}])=>h.createElement(Ft,{...t,key:e,isOpen:n},t.content))})}class At{_change;_prepare;_uniqueId=Je("m-");_bind=(e,t)=>{this._change=e,this._prepare=t};append=(e,t)=>{this._change(n=>{const o=new Map(n);return o.set(e,{config:t,isOpen:!0}),o})};update=(e,t)=>{this._change(n=>{const o=n.get(e);if(!o)return n;const a=new Map(n);return a.set(e,{...o,config:{...o.config,...t}}),a})};close=e=>{this._change(t=>{const n=t.get(e);if(!n)return t;const o=new Map(t);return o.set(e,{...n,isOpen:!1}),o})};finish=e=>{this._change(t=>{if(!t.has(e))return t;const n=new Map(t);return n.delete(e),n})};generate=e=>{const{promise:t,resolve:n}=Ne();return{promise:t,wrap:(o,a,i=!1)=>{const l=()=>{n(a),this.close(e)};return c=>{const u=o?.(c);return i||!de(u)?l():u.then(l)}}}};confirm=e=>{const t=this._uniqueId(),{promise:n,wrap:o}=this.generate(t),a=this._prepare(e);return a.onOk=o(e.onOk,!0),a.onCancel=o(e.onCancel,!1),a.onClosed=Ke(e.onClosed,()=>{this.finish(t)}),a._onDismiss=o(e.onCancel,!1,!0),a._showCancel=!j(e.onCancel)||a.type==="confirm",this.append(t,a),{then:i=>n.then(i),update:i=>{this.update(t,i)},close:()=>{this.close(t)}}};expose=()=>{const{confirm:e}=this;return Object.assign(ve().reduce((t,n)=>(t[n]=o=>e({...o,type:n}),t),{}),{confirm:e})}}function $e(){const[s,e]=h.useState(()=>new Map),t=ue(()=>new At);return ye(()=>{t._bind(o=>{e(o)},o=>A(o,Ye(dt,mt)))}),[h.useMemo(()=>t.expose(),[t]),r.jsx(Ht,{items:s},"modal-holder")]}const S=Object.assign(Rt,_t.expose(),{useModal:$e});function Xt(){const[s,e]=h.useState(!1);return r.jsxs(r.Fragment,{children:[r.jsx(p,{variant:"solid",onClick:()=>e(!0),children:"Open Modal"}),r.jsxs(S,{isOpen:s,title:"Basic Modal",onCancel:()=>{e(!1)},onOk:()=>{e(!1)},children:[r.jsx("p",{children:"Some contents..."}),r.jsx("p",{children:"Some contents..."}),r.jsx("p",{children:"Some contents..."})]})]})}const Yt={metaInfo:{"zh-CN":`基本的对话框使用方式。
