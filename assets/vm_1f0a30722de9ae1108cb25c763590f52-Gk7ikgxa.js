import{j as n}from"./index-CwOYnZSN.js";import{B as t}from"./index-JCnzRmOf.js";import{S as r}from"./index-eX8kjn-g.js";function d(){return n.jsxs(r,{wrap:!0,children:[n.jsx(t,{variant:"filled",children:"Primary Button"}),n.jsx(t,{children:"Default Button"}),n.jsx(t,{variant:"dashed",children:"Dashed Button"}),n.jsx(t,{variant:"text",children:"Text Button"})]})}const s={desc:{"zh-CN":`按钮分为 主要按钮、次要按钮、虚线按钮、线形按钮和文本按钮五种。
