...
\`\`\`
`,cssName:"css-612a8888",relPath:"packages/core/src/modal/__docs__/examples/basic.md"},Te=m.createContext(null),ze=m.createContext(null),A={title:"Use Hook!",onOk:async()=>{await new Promise(s=>setTimeout(s,1e3))},content:r.jsxs(r.Fragment,{children:[r.jsx(Te.Consumer,{children:s=>`Reachable: ${s}!`}),r.jsx("br",{}),r.jsx(ze.Consumer,{children:s=>`Unreachable: ${s}!`})]})};function sn(){const[s,e]=M.useModal();return r.jsxs(Te,{value:"Light",children:[r.jsxs(Ne,{children:[r.jsx(f,{theme:"info",onClick:()=>{s.confirm(A)},children:"Confirm"}),r.jsx(f,{theme:"info",onClick:()=>{s.warning(A)},children:"Warning"}),r.jsx(f,{theme:"info",onClick:()=>{s.info(A)},children:"Info"}),r.jsx(f,{theme:"info",onClick:()=>{s.error(A)},children:"Error"})]}),e,r.jsx(ze,{value:"Bamboo"})]})}const an={metaInfo:{"zh-CN":`通过 Modal.useModal 创建支持读取 context 的 contextHolder。其中仅有 hooks 方法支持 Promise await 操作。
