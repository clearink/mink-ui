import{j as e}from"./index-B9VCtSys.js";import{B as o}from"./index-CGqzzYup.js";import{T as n}from"./index-Dx4ITALr.js";import{S as a}from"./index-Dt4utubC.js";function d(){return e.jsx(n,{content:"prompt text",children:e.jsx("span",{children:"Tooltip will show on mouse enter."})})}const u={metaInfo:{"zh-CN":`最简单的用法，鼠标悬停即可显示 Tooltip。
...
\`\`\`
`,cssName:"css-c49593bf",relPath:"packages/core/src/tooltip/__docs__/examples/basic.md"},r=["topLeft","top","topRight"],s=["bottomLeft","bottom","bottomRight"],l=["leftTop","left","leftBottom"],i=["rightTop","right","rightBottom"];function f(){return e.jsxs("div",{className:"placement-grid",children:[e.jsx("div",{className:"placement-row",children:r.map(t=>e.jsx(n,{content:t,placement:t,children:e.jsx(o,{children:t})},t))}),e.jsxs("div",{className:"placement-row",children:[e.jsx("div",{className:"placement-side",children:l.map(t=>e.jsx(n,{content:t,placement:t,children:e.jsx(o,{children:t})},t))}),e.jsx("div",{className:"placement-center"}),e.jsx("div",{className:"placement-side",children:i.map(t=>e.jsx(n,{content:t,placement:t,children:e.jsx(o,{children:t})},t))})]}),e.jsx("div",{className:"placement-row",children:s.map(t=>e.jsx(n,{content:t,placement:t,children:e.jsx(o,{children:t})},t))})]})}const g={metaInfo:{"zh-CN":"通过 `placement` 属性设置 Tooltip 的弹出位置，支持 12 个方向。\n\n","en-US":"Set the popup position with the `placement` attribute. There are 12 placement options available.\n\n"},rawText:`\`\`\`tsx
