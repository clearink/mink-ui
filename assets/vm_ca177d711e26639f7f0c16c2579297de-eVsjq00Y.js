import{j as t}from"./index-CsKKL_Kz.js";import{S as o,M as n}from"./index-M5IjEHzL.js";import{C as e}from"./index-D-Ksilcc.js";import{A as i,a as r,b as l}from"./vm_0b3242867ddba75eca11b802f30b3be7-D31bJEnt.js";import"./index-BC_TnJie.js";import"./index-ByX4AT8g.js";import"./reflow-DEXvfG9L.js";function w(){return t.jsxs("div",{className:"source-container",children:[t.jsx(o,{title:"何时使用",children:t.jsx(n,{rawText:"随你"})}),t.jsx(o,{title:"代码演示",children:t.jsx(e,{items:[{desc:{"zh-CN":`基础用法
...
\`\`\`
`},disabled:!1,element:t.jsx("div",{className:"tooltip-example-Basic",children:t.jsx(i,{})}),rawText:`\`\`\`tsx
import { Tooltip } from '@mink-ui/core'
...
\`\`\`
`},disabled:!1,element:t.jsx("div",{className:"tooltip-example-Adjust",children:t.jsx(r,{})}),rawText:`\`\`\`tsx
import { Button, Tooltip } from '@mink-ui/core'
import { useEffect, } from 'react'
...
\`\`\`
`},disabled:!1,element:t.jsx("div",{className:"tooltip-example-Placement",children:t.jsx(l,{})}),rawText:`\`\`\`tsx
import { Button, Segmented, Space, Tooltip } from '@mink-ui/core'
import { useMemo, useState } from 'react'
